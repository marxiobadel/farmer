                    ...
                    <div className="lg:grid lg:grid-cols-12 lg:gap-x-12">
                        ...
                        <aside className="lg:col-span-3 mb-8 lg:mb-0">
                            <div className="sticky top-8">
                                <ProfileSidebar className="bg-white/50 backdrop-blur-xl border border-stone-200/60 rounded-2xl p-4 shadow-sm" />
                            </div>
                        </aside>
                        ...
                        <div className="lg:col-span-9 space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {/* Stat: Commandes */}
                                <Card className="relative overflow-hidden border-stone-200/60 bg-white/60 shadow-sm hover:shadow-md transition-all duration-300 group">
                            ...
                            <div className="space-y-4">
                                ...
                                <Card className="border-stone-200/60 shadow-sm overflow-hidden bg-white/80 backdrop-blur-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="rounded-2xl bg-gradient-to-br from-stone-900 to-stone-800 text-white p-6 shadow-xl flex flex-col justify-between">
                                    ...
                                    <div className="mt-6 pt-6 border-t border-white/10">
                                        <Link href="#" className="text-sm font-medium text-white hover:text-primary-foreground/80 flex items-center gap-2 transition-colors">
